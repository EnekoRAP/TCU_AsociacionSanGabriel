...
<body>
    ...
    <script>
        const faqs = [
            ...
            ["fas fa-ban text-danger", "¿Qué hago si no puedo ingresar?", "Puede ser por credenciales inválidas o porque tu usuario está inactivo. Contactá al master para verificar tu estado."],
